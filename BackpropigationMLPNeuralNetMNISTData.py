# -*- coding: utf-8 -*-
"""
Created on Sun Sep 20 15:33:58 2020

@author: sefir
"""
#MNIST DATA SET READING IT
import os as os
import struct
import numpy as np
...
#Create, Run a NeuralNetwork Multilayer Perceptron via BackPropigation
...
print("Evaluationg Generalization Performance")
print("\n")
y_test_pred = nn.predict(X_test)
acc = (np.sum(y_test == y_test_pred).astype(np.float) / X_test.shape[0])
print('Training accuracy: %2f%%' % (acc*100))

#Images MLP Struggles With
print("Images MLP Struggles With")
print("\n")
